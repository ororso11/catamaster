...
function previewSite(id) {
    ...
    previewContainer.innerHTML = `
        ...
        <div style="margin-bottom: 30px; display: flex; gap: 15px;">
            ...
            <button onclick="downloadFiles('${catalog.id}')" 
                    style="padding: 12px 25px; background: #FF9800; color: white; border: none; border-radius: 5px; cursor: pointer; font-size: 14px; font-weight: 600;">
                💾 전체 다운로드
            </button>
        </div>
        
        <div style="background: #f9f9f9; padding: 20px; border-radius: 8px; margin-bottom: 30px;">
            <h4 style="margin-bottom: 10px; color: #333;">💡 사용 방법</h4>
            <ol style="color: #666; line-height: 1.8; padding-left: 20px;">
                <li><strong>index.html</strong>: 제품 카탈로그 웹사이트 (고객용)</li>
                <li><strong>admin.html</strong>: 관리자 페이지</li>
                <li>다운로드한 HTML 파일을 브라우저에서 바로 열어보세요</li>
                <li>모든 데이터는 HTML 파일 안에 포함되어 있습니다</li>
            </ol>
        </div>
        
        <h4 style="margin-bottom: 15px;">미리보기 (index.html)</h4>
